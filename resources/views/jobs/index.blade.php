    ...
    <x-card class="mb-6">
        <form method="GET" action="{{ route('jobs.index') }}" class="flex flex-col sm:flex-row gap-3">
            <div class="flex-1 relative">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search jobs by title or company…"
                ...
                <div class="flex items-start justify-between mb-3">
                    <div class="min-w-0">
                        ...
                        @if($jobPost->company_name)
                            <p class="text-xs font-medium text-indigo-600 mt-0.5 flex items-center gap-1">
